...
<body class="antialiased bg-gray-50">
    ...
    <div class="hero-pattern bg-green-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div class="text-center">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    <span class="block xl:inline">Professional hospital</span>
                    <span class="block text-green-600 xl:inline"> Management Solution</span>
                </h1>
                <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    Experience seamless hospital operations with our state-of-the-art management system designed to enhance Patient satisfaction and streamline workflow.
                </p>
                <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                    ...
                    <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                        <a href="#" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-green-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
                            Learn More
                        </a>
                    </div>
                </div>
    ...
    <!-- Features Section (Medical-style) -->
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                <h2 class="text-base text-green-600 font-semibold tracking-wide uppercase">Features</h2>
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    Advanced hospital Management Tools
                </p>
                <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                    Comprehensive tools designed specifically for the hospitality industry to enhance service quality and operational efficiency.
                </p>
            </div>
            ...
            <div class="mt-10">
                <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            <h3 class="text-lg font-medium text-gray-900">Reservation Management</h3>
                            <p class="mt-2 text-base text-gray-500">
                                Efficiently manage room reservations, check-ins, and check-outs with our intuitive system.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Seamlessly handle billing, generate invoices, and process payments with our secure platform.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Track and manage hospital inventory with real-time updates and automated reordering.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="py-12 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h2 class="text-3xl font-extrabold text-gray-900">Comprehensive Hospital Management</h2>
                <p class="mt-4 text-lg text-gray-500">Everything you need to manage your healthcare facility efficiently</p>
            </div>
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">Efficiently manage doctors, nurses, and administrative staff</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">Complete digital patient records and history management</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">Streamline patient appointments and resource allocation</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-green-700">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                <span class="block">Ready to transform your hospital management?</span>
            ...
            <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                ...
                <div class="ml-3 inline-flex rounded-md shadow">
                    <a href="#" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-800 hover:bg-green-900">
                        Learn more
                    </a>
                </div>
            </div>
