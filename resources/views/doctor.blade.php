        ...
        <div class="doctor-grid grid">
            ...
            <div class="glass-card floating-elements relative rounded-2xl p-6 sm:p-10 transition-all duration-500 group">
                ...
                <div class="relative flex flex-col items-center mb-6">
                    <div class="relative w-full flex justify-center">
                        <div class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2  rounded-full p-0.5  shadow-lg">
                            ...
                            @if($doctor->is_verified)
                            <div class="absolute -bottom-0 -right-0 bg-green-500 rounded-full p-1.5 border-2 border-white shadow-lg">
                ...
                <div class="relative">
                    ...
                    class="btn-primary w-full py-3 px-6 rounded-xl text-white font-semibold transition-all duration-300 flex items-center justify-center space-x-2">
